#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/zettlr.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
#zettlr : A markdown editor for writing academic texts and taking notes
export BIN="zettlr.appimage"
export BIN_ID="com.zettlr.Zettlr"
export ARCHLINUX_PKG="zettlr"
export REPOLOGY_PKG="zettlr"
export SOURCE_URL="https://github.com/Zettlr/Zettlr"
#-------------------------------------------------------#
