#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/olive-editor.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="olive-editor.appimage"
export BIN_ID="org.olivevideoeditor.Olive"
export ARCHLINUX_PKG="olive"
export REPOLOGY_PKG="olive-video-editor"
