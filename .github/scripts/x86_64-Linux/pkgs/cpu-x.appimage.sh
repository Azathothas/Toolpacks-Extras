#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/cpu-x.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
#cpu-x : A FOSS tool to gather information on CPU, motherboard and more
export BIN="cpu-x.appimage"
export BIN_ID="io.github.thetumultuousunicornofdarkness.cpu-x"
export ARCHLINUX_PKG="cpu-x"
export REPOLOGY_PKG="cpu-x"
export SOURCE_URL="https://github.com/TheTumultuousUnicornOfDarkness/CPU-X"
#-------------------------------------------------------#
