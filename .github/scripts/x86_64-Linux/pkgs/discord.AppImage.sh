#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/discord.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="discord.appimage"
export BIN_ID="com.discordapp.Discord"
export ARCHLINUX_PKG="discord"
export REPOLOGY_PKG="discord"
export SOURCE_URL="https://github.com/srevinsaju/discord-appimage"
#-------------------------------------------------------#
