#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/heroic.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="heroic.appimage"
export BIN_ID="com.heroicgameslauncher.hgl"
export ARCHLINUX_PKG="heroic"
export REPOLOGY_PKG="heroic"
export SOURCE_URL="https://github.com/Heroic-Games-Launcher/HeroicGamesLauncher"
#-------------------------------------------------------#
