#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/obsidian.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="obsidian.appimage"
export BIN_ID="md.obsidian.Obsidian"
export ARCHLINUX_PKG="obsidian"
export REPOLOGY_PKG="obsidian"
export SOURCE_URL="https://github.com/obsidianmd/obsidian-releases"
#-------------------------------------------------------#
