#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/amdgpu_top.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="amdgpu_top.appimage"
export BIN_ID="xxx.amdgpu_top"
export ARCHLINUX_PKG="amdgpu_top"
export REPOLOGY_PKG="amdgpu-top"
export SOURCE_URL="https://github.com/Umio-Yasuno/amdgpu_top"
#-------------------------------------------------------#
