#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/protonup-qt.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="protonup-qt.appimage"
export BIN_ID="net.davidotek.pupgui2"
export ARCHLINUX_PKG="protonup-qt"
export REPOLOGY_PKG="protonup-qt"
export SOURCE_URL="https://github.com/DavidoTek/ProtonUp-Qt"
#-------------------------------------------------------#
