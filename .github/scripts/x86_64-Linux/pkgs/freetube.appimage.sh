#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/freetube.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="freetube.appimage"
export BIN_ID="io.freetubeapp.FreeTube"
export ARCHLINUX_PKG="freetube"
export REPOLOGY_PKG="freetube"
export SOURCE_URL="https://github.com/FreeTubeApp/FreeTube"
#-------------------------------------------------------#
