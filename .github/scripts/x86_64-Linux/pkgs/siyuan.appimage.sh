#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/siyuan.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
#siyuan : A privacy-first personal knowledge management system that supports complete offline usage
export BIN="siyuan.appimage"
export BIN_ID="org.b3log.siyuan"
export ARCHLINUX_PKG="siyuan"
export REPOLOGY_PKG="siyuan"
export SOURCE_URL="https://github.com/siyuan-note/siyuan"
#-------------------------------------------------------#
