#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/i3.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="i3.appimage"
export BIN_ID="org.i3wm.i3"
export ARCHLINUX_PKG="i3-wm"
export APK_PKG="i3wm"
export DEB_PKG="i3-wm"
export REPOLOGY_PKG="i3"
