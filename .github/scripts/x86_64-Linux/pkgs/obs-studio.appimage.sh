#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/obs-studio.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="obs-studio.appimage"
export BIN_ID="org.obs-studio.obs-studio"
export ARCHLINUX_PKG="obs-studio"
export APK_PKG="obs-studio"
export REPOLOGY_PKG="obs-studio"
export SOURCE_URL="https://github.com/obs-studio-mirror/obs-studio"
#-------------------------------------------------------#
