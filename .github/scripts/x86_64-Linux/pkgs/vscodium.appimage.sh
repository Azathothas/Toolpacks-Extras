#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/vscodium.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="vscodium.appimage"
export BIN_ID="com.vscodium.codium"
export ARCHLINUX_PKG="vscodium"
export REPOLOGY_PKG="vscodium"
export SOURCE_URL="https://github.com/VSCodium/vscodium"
#-------------------------------------------------------#
