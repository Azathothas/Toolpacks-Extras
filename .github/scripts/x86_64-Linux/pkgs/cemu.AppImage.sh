#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/cemu.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
#cemu : Wii U emulator
export BIN="cemu.appimage"
export BIN_ID="info.cemu.Cemu"
export ARCHLINUX_PKG="cemu"
export REPOLOGY_PKG="cemu-wii-u-emulator"
export SOURCE_URL="https://github.com/cemu-project/Cemu"
#-------------------------------------------------------#
