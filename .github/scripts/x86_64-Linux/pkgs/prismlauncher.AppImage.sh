#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/prismlauncher.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="prismlauncher.appimage"
export BIN_ID="org.prismlauncher.PrismLauncher"
export REPOLOGY_PKG="prismlauncher"
export SOURCE_URL="https://github.com/PrismLauncher/PrismLauncher"
#-------------------------------------------------------#
