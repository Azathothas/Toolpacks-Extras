#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/wezterm.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="wezterm.appimage"
export BIN_ID="org.wezfurlong.wezterm"
export ARCHLINUX_PKG="wezterm"
export REPOLOGY_PKG="wezterm"
export SOURCE_URL="https://github.com/wez/wezterm"
#-------------------------------------------------------#
