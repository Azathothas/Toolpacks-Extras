#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/steam.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
if [ "${SKIP_BUILD}" == "NO" ]; then
    ...
    #Enrichments
     curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/assets/icons/steam_scr.png" -o "${BINDIR}/${BIN}.scr.png"
