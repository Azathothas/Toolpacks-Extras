...
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/hf_build_temp_pkg.sh")
...
{
   #Set local env
    local GH_REPO_DL="https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts"
