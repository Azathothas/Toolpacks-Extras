...
## Self: https://raw.githubusercontent.com/pkgforge/soarpkgs/refs/heads/main/scripts/metadata/gen_meta_aio_x86_64-Linux.sh
# bash <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/soarpkgs/refs/heads/main/scripts/metadata/gen_meta_aio_x86_64-Linux.sh")
#-------------------------------------------------------#
