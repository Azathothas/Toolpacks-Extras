...
## Self: https://raw.githubusercontent.com/pkgforge/soarpkgs/refs/heads/main/scripts/metadata/fetch_flatpak.sh
# bash <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/soarpkgs/refs/heads/main/scripts/metadata/fetch_flatpak.sh")
#-------------------------------------------------------#
