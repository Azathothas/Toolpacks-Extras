#!/usr/bin/env bash
#self source: 
# source <(curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/main/.github/scripts/${HOST_TRIPLET}/pkgs/browservice.appimage.sh") 
set +x
#-------------------------------------------------------#
#Sanity Checks
if [ "${BUILD}" != "YES" ] || \
...
export BIN="browservice.appimage"
export BIN_ID="org.browservice.browservice"
export ARCHLINUX_PKG="browservice"
export REPOLOGY_PKG="browservice"
