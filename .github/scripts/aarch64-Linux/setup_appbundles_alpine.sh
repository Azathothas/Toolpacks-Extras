...
#And more
#self:
# bash <(curl -qfsSL "https://raw.githubusercontent.com/Azathothas/Toolpacks-Extras/main/.github/scripts/setup_appbundles_alpine")
set -x
...
##Alpine Minimal ROOTFS
 ...
 APPDIR="/opt/rootfs/AppBundles/alpine-minimal.AppDir" && export APPDIR="${APPDIR}" ; sudo mkdir -p "${APPDIR}/usr/bin"
