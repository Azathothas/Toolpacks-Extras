#!/bin/sh
set -u
##This is an example/template on how AM can use pkgcache's METADATA (https://pkg.pkgforge.dev/x86_64/METADATA.min.json)
#Or to use the full version: https://huggingface.co/datasets/pkgforge/pkgcache/resolve/main/x86_64-Linux/METADATA.json
#Fields Available:
...
APP="puddletag"
#The src is just the root url, the original is: https://huggingface.co/datasets/pkgforge/pkgcache/resolve/main/x86_64-Linux
SRC="https://pkg.pkgforge.dev/$(uname -m)"
#The type tells us what kind of package it is, Details: https://github.com/pkgforge/pkgcache/tree/main/Docs
TYPE="NixAppImage"
