...
#More Details: https://github.com/pkgforge/pkgcache/blob/main/Docs/NIXAPPIMAGES.md
#Self: curl -qfsSL "https://raw.githubusercontent.com/pkgforge/pkgcache/refs/heads/main/.github/assets/nix-flakes/numtide_nix-gl-host.nix" -o "./flake.nix"
